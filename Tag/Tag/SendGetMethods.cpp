...
bool Client::SendVector(std::string & _v)
{
	...
	if (!sendall((char*)_v.c_str(), bufferlength)) //Try to send string buffer... If buffer fails to send,
		return false; //Return false: Failed to send string buffer
	return true; //Return true: string successfully sent
}

bool Client::GetVector(std::string & _v)
{
